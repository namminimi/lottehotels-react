            ...
            <div>
                <form onSubmit={onSubmit}>
                    <table>
                        ...
                        <tr>
                            <td>별명</td>
                            <td><input type="text" name="m_nickname" value={formData.m_nickname} onChange={onChange}/></td>
                        </tr>
                        <tr>
                            <td>전화번호</td>
                            <td><input type="text" name="m_phone" value={formData.m_phone} onChange={onChange}/></td>
                        </tr>
                        <tr>
                            <td>주소</td>
                            <td><input type="text" name="m_add1" value={formData.m_add1} onChange={onChange}/>
                            <input type="text" name="m_add2" value={formData.m_add2} onChange={onChange}/>
                            <button onClick={openPostCode}>우편번호 검색</button>
                            <div id="popupDom">
                                {isPopupOpen && (
                                    <PopupDom>
                                        <PopupPage onClose={closePostCode}
                                        onAddData={onAddData}/>
                                    </PopupDom>
                                )}
                            </div>
