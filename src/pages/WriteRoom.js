...
const WriteRoom = () => {
    ...
    const [ amenitys, setAmenitys ] = useState([
        ...
        {id: 5, text: "욕실(욕조, 사워부스)", checked: false},
        ...
        {id: 10, text: "와인 셀러", checked: false},
    ])
            ...
            <form onSubmit={onSubmit}>
                <table className='defaulttable'>
                    <tbody>
                        <tr>
                            <td>방이름</td>
                            <td><input type="text" name='r_name' value={formData.r_name}
                        ...
                        <tr>
                            ...
                            <td>
                                <select name='r_bed' onChange={onChange} value={formData.r_bed}>
                                    ...
                                    <option value='싱글 베드 1개 & 세메 더블 베드 1개'>싱글 베드 1개 & 세메 더블 베드 1개</option>
                                    <option value='할리우드 베드 1개 (세미 더블 베드 2개 일체형)'>할리우드 베드 1개 (세미 더블 베드 2개 일체형)</option>
                                    <option value='싱글베드 2개 & 침구류 1세트'>싱글베드 2개 & 침구류 1세트</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                onChange={()=>checkClick(amenity.id)}/></div>)}
                            </td>
                        </tr>
                        <tr>
                            <td>이용요금</td>
                            <td>
                                ...
                                value={formData.r_price} onChange={onChange}></input>
                            </td>
                        </tr>
                        <tr>
                            <td>이미지1</td>
                            <td>
                                ...
                                {formData.r_img1 && <div>
                                    <img src={`${API_URL}/upload/event/${formData.r_img1}`} width="100px"  alt=""/></div>}
                            </td>
                        </tr>
                        <tr>
                            <td>이미지2</td>
                            <td>
                                ...
                                {formData.r_img2 && <div>
                                    <img src={`${API_URL}/upload/event/${formData.r_img2}`} width="100px"  alt=""/></div>}
                            </td>
                        </tr>
                        <tr>
                            <td>이미지3</td>
                            <td>
                                ...
                                {formData.r_img3 && <div>
                                    <img src={`${API_URL}/upload/event/${formData.r_img3}`} width="100px"  alt=""/></div>}
                            </td>
                        </tr>
                        <tr>
                            <td>이미지4</td>
                            <td>
                                ...
                                {formData.r_img4 && <div>
                                    <img src={`${API_URL}/upload/event/${formData.r_img4}`} width="100px"  alt=""/></div>}
                            </td>
                        </tr>
                        <tr>
                            <td>상세설명글</td>
