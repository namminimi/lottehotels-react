            ...
            <form onSubmit={onSubmit}>
                <table>
                    <tbody>
                        <tr>
                            <td>제목</td>
                            <td><input type="text" name='e_title' value={formData.e_title}
                            onChange={onChange}/></td>
                        </tr>
                        <tr>
                            <td>기간</td>
                            <td><input type="text" name='e_time' value={formData.e_time}
                            onChange={onChange}/></td>
                        </tr>
                        <tr>
                            <td>간략설명</td>
                            <td><input type="text" name='e_titledesc' value={formData.e_titledesc}
                            onChange={onChange}/></td>
                        </tr>
                        <tr>
                            <td>분류</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {formData.e_img2 && <div>
                                    <img src={`${API_URL}/upload/event/${formData.e_img2}`} width="100px"  alt=""/></div>}
                            </td>
                        </tr>
                        <tr>
                            <td>상세설명글</td>
